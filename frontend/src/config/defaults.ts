...
export const FOOTBALL_FORMATIONS: FormationConfig[] = [
  ...
  },
  {
    ...
    positions: [
      ...
      { id: 'CD2', x: 32, y: 82, label: 'DFC', fullName: 'Defensa Central' },
      { id: 'LI', x: 8, y: 78, label: 'LI', fullName: 'Lateral Izquierdo' },
      { id: 'MCD1', x: 62, y: 65, label: 'MCD', fullName: 'Mediocentro Defensivo' },
      { id: 'MCD2', x: 38, y: 65, label: 'MCD', fullName: 'Mediocentro Defensivo' },
      { id: 'MD', x: 92, y: 42, label: 'MD', fullName: 'Extremo Derecho' },
      { id: 'MCO', x: 50, y: 45, label: 'MCO', fullName: 'Mediapunta' },
      { id: 'MI', x: 8, y: 42, label: 'MI', fullName: 'Extremo Izquierdo' },
      { id: 'DC', x: 50, y: 22, label: 'DC', fullName: 'Delantero Centro' },
    ],
  },
  {
