...
export const FOOTBALL_FORMATIONS: FormationConfig[] = [
  {
    ...
    positions: [
      ...
      { id: 'LD', x: 92, y: 68, label: 'LD', fullName: 'Lateral Derecho' },
      { id: 'CD1', x: 68, y: 82, label: 'DFC', fullName: 'Defensa Central' },
      { id: 'CD2', x: 32, y: 82, label: 'DFC', fullName: 'Defensa Central' },
      { id: 'LI', x: 8, y: 68, label: 'LI', fullName: 'Lateral Izquierdo' },
      { id: 'MC', x: 50, y: 54, label: 'MC', fullName: 'Mediocentro' },
      { id: 'MCO1', x: 75, y: 44, label: 'MCO', fullName: 'Mediapunta' },
      { id: 'MCO2', x: 25, y: 44, label: 'MCO', fullName: 'Mediapunta' },
  ...
  },
  {
    ...
    positions: [
      { id: 'GK', x: 50, y: 92, label: 'POR', fullName: 'Portero' },
      { id: 'LD', x: 92, y: 70, label: 'LD', fullName: 'Lateral Derecho' },
      { id: 'CD1', x: 68, y: 82, label: 'DFC', fullName: 'Defensa Central' },
      { id: 'CD2', x: 32, y: 82, label: 'DFC', fullName: 'Defensa Central' },
      { id: 'LI', x: 8, y: 70, label: 'LI', fullName: 'Lateral Izquierdo' },
      { id: 'MD', x: 92, y: 40, label: 'MD', fullName: 'Mediocampista Derecho' },
      { id: 'MC1', x: 60, y: 47, label: 'MC', fullName: 'Mediocentro' },
      { id: 'MC2', x: 40, y: 47, label: 'MC', fullName: 'Mediocentro' },
      { id: 'MI', x: 8, y: 40, label: 'MI', fullName: 'Mediocampista Izquierdo' },
  ...
  },
  {
    ...
    positions: [
      ...
      { id: 'CD2', x: 32, y: 82, label: 'DFC', fullName: 'Defensa Central' },
      { id: 'LI', x: 8, y: 70, label: 'LI', fullName: 'Lateral Izquierdo' },
      { id: 'MCD1', x: 62, y: 50, label: 'MCD', fullName: 'Mediocentro Defensivo' },
      { id: 'MCD2', x: 38, y: 50, label: 'MCD', fullName: 'Mediocentro Defensivo' },
      { id: 'MD', x: 92, y: 40, label: 'MD', fullName: 'Extremo Derecho' },
      { id: 'MCO', x: 50, y: 36, label: 'MCO', fullName: 'Mediapunta' },
  ...
  },
  {
    ...
    positions: [
      { id: 'GK', x: 50, y: 92, label: 'POR', fullName: 'Portero' },
      { id: 'CAD', x: 94, y: 57, label: 'CAD', fullName: 'Carrilero Derecho' },
      ...
      { id: 'CAI', x: 6, y: 57, label: 'CAI', fullName: 'Carrilero Izquierdo' },
      { id: 'MC1', x: 65, y: 44, label: 'MC', fullName: 'Mediocentro' },
      { id: 'MC2', x: 50, y: 48, label: 'MC', fullName: 'Mediocentro' },
      { id: 'MC3', x: 35, y: 44, label: 'MC', fullName: 'Mediocentro' },
      { id: 'DC1', x: 65, y: 25, label: 'DC', fullName: 'Delantero Centro' },
      { id: 'DC2', x: 35, y: 25, label: 'DC', fullName: 'Delantero Centro' },
    ],
  },
