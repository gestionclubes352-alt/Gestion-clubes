...
const ZONES: Record<string, EllipseZone | { left: EllipseZone; right: EllipseZone }> = {
  ...
  HOMBRO: {
    left: { cx: 33, cy: 24, rx: 6, ry: 4 },
    right: { cx: 67, cy: 24, rx: 6, ry: 4 },
  },
  'CLAVÍCULA': { cx: 50, cy: 21, rx: 12, ry: 3 },
  COSTILLAS: { cx: 50, cy: 30, rx: 12, ry: 9 },
  ESPALDA: { cx: 50, cy: 30, rx: 12, ry: 9 },
  ABDOMEN: { cx: 50, cy: 38, rx: 9, ry: 7 },
  PUBIS: { cx: 50, cy: 46, rx: 6, ry: 3 },
  BRAZO: {
    left: { cx: 22, cy: 25, rx: 8, ry: 3 },
    right: { cx: 78, cy: 25, rx: 8, ry: 3 },
  },
  CODO: {
    left: { cx: 12, cy: 30, rx: 3, ry: 3 },
    right: { cx: 88, cy: 30, rx: 3, ry: 3 },
  },
  ANTEBRAZO: {
    left: { cx: 8, cy: 34, rx: 8, ry: 3 },
    right: { cx: 92, cy: 34, rx: 8, ry: 3 },
  },
  'MUÑECA': {
    left: { cx: 3, cy: 39, rx: 2.5, ry: 2.5 },
    right: { cx: 97, cy: 39, rx: 2.5, ry: 2.5 },
  },
  MANO: {
    left: { cx: 1, cy: 43, rx: 4, ry: 5 },
    right: { cx: 99, cy: 43, rx: 4, ry: 5 },
  },
