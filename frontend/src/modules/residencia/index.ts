// Barrel export para el módulo Residencia

export { default as HabitacionesView } from './components/HabitacionesView';
export { default as EstadoHabitacionesView } from './components/EstadoHabitacionesView';
...
export { default as ComedorQrImprimirView } from './components/ComedorQrImprimirView';
