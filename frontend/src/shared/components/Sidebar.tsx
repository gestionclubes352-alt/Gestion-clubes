    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 py-4 overflow-y-auto overflow-x-hidden scrollbar-hide">
          ...
          <SidebarSection title={t('sidebar.residencia')} sectionKey="residencia" collapsed={isCollapsed} hasActiveChild={['RESI_JUGADORES', 'RESI_HABITACIONES', 'RESI_ESTADO_HABITACIONES', 'RESI_COMEDOR'].includes(activeSection)} expandedSections={expandedSections} onToggleSection={toggleSection}>
            ...
            {isVisible('RESI_COMEDOR') && <SidebarItem icon="fa-utensils" label={t('sidebar.residenciaDiningLabel')} active={activeSection === 'RESI_COMEDOR'} onClick={() => handleItemClick('RESI_COMEDOR')} collapsed={isCollapsed} />}
          </SidebarSection>
          )}
