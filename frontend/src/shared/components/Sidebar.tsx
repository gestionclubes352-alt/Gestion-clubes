    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 py-4 overflow-y-auto overflow-x-hidden scrollbar-hide">
          ...
          <SidebarSection title={t('sidebar.residencia')} sectionKey="residencia" collapsed={isCollapsed} hasActiveChild={['RESI_JUGADORES', 'RESI_HABITACIONES', 'RESI_ESTADO_HABITACIONES', 'RESI_COMIDAS', 'RESI_COMEDOR'].includes(activeSection)} expandedSections={expandedSections} onToggleSection={toggleSection}>
            ...
            {isVisible('RESI_ESTADO_HABITACIONES') && <SidebarItem icon="fa-clipboard-check" label={t('sidebar.residenciaRoomsStatusLabel')} active={activeSection === 'RESI_ESTADO_HABITACIONES'} onClick={() => handleItemClick('RESI_ESTADO_HABITACIONES')} collapsed={isCollapsed} />}
            ...
            {isVisible('RESI_COMEDOR') && <SidebarItem icon="fa-qrcode" label={t('sidebar.residenciaDiningLabel')} active={activeSection === 'RESI_COMEDOR'} onClick={() => handleItemClick('RESI_COMEDOR')} collapsed={isCollapsed} />}
          </SidebarSection>
          )}
