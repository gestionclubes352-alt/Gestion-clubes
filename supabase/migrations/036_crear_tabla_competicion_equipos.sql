...
CREATE TABLE IF NOT EXISTS competicion_equipos (
  ...
  equipo_id TEXT NOT NULL REFERENCES plantillas(id) ON DELETE CASCADE,
...
COMMENT ON COLUMN competicion_equipos.equipo_id IS 'ID del equipo (de la tabla plantillas)';
